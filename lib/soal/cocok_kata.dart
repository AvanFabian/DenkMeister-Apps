...
class CocokKata extends StatefulWidget {
  ...
  const CocokKata({super.key, required this.currentlevel, required this.onProgressUpdate, required this.difficulty, required this.levelMark});
...
class _CocokKataState extends State<CocokKata> {
  ...
  Future<void> loadQuestions() async {
    try {
      final String jsonString = await rootBundle.loadString('assets/utils/cocokkata_quiz.json');
  ...
  Future<void> _checkAnswer(String selectedAnswer) async {
    ...
    await QuizProgressManager.saveAnsweredQuestion('cocok_kata', widget.currentlevel, widget.difficulty);
        ...
        Future.delayed(const Duration(seconds: 2), () {
          ...
          setState(() {
            ...
            if (_currentQuestionIndex < _questions.length - 1) {
              ...
              QuizProgressManager.saveLevelCompletion('cocok_kata', widget.levelMark, widget.difficulty);
